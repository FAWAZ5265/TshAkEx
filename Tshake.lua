...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,633004612,1619524486}
print([[
...
download_to_file('https://raw.githubusercontent.com/FAWAZ5265/TshAkEx/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/FAWAZ5265/TshAkEx/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/FAWAZ5265/files_tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/FAWAZ5265/files_tshake/master/files_tshake/"..file)
if res == 200 then
